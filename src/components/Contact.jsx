...
import { Mail, Phone, MapPin, Linkedin, Github } from 'lucide-react'; // Icons
...
const ContactSection = () => {
    ...
    return (
        <section 
            id="contact" 
            className="relative py-24 md:py-32 bg-gray-900 text-white min-h-[80vh] overflow-hidden" 
        >
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    >
                        <h3 className="text-2xl font-bold text-teal-400 border-b border-teal-500/30 pb-3">Get in Touch</h3>
                        
                        <div className="space-y-5 text-lg">
                            <ContactItem icon={Mail} title="Email Me" value="kaifb9105@gmail.com" link="mailto:mohd.kaif@example.com" />
                            <ContactItem icon={Phone} title="Call Me" value="(+91) 9837025284" link="tel:+919876543210" />
